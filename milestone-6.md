...
The output of the command `istioctl proxy-config endpoint` for the Istio ingress gateway pod corresponding to the frontend cluster shows two hosts related to the old and the new replica.
